...
/* network */
/* type*/
const p_type = getval('type')
/* method*/
const h_method = getVal('method')
...
function setType(p, p_type) {
  return p.map(p => {
    return p.type === p_type && (p.port != 8080 || p.port != 443 || p.port != 80) ;
  });
}
