...
DOMAIN,ad-channel.woyeahgo.tk,REJECT
...
DOMAIN,oset-api.open-adx.com,REJECT
DOMAIN,sdkauth.hpplay.cn,REJECT
...
DOMAIN,tunion-api.m.taobao.com,REJECT
IP-CIDR,112.29.211.120/32,REJECT,no-resolve
# > Apple
...
IP-CIDR,103.75.152.210/32,REJECT,no-resolve
IP-CIDR,103.75.153.3/32,REJECT,no-resolve
# (B)
# > Baidu
...
# > bika
DOMAIN,ad-display.wikawika.xyz,REJECT
DOMAIN,ads.wakamoment.tk,REJECT
# > BitAuto
...
# (D)
# > 懂球帝
DOMAIN,ap.dongqiudi.com,REJECT
# (G)
# > Google
...
# (R)
# > 人人影视字幕组
DOMAIN,tj.playcvn.com,REJECT
DOMAIN,tu.cvnad.com,REJECT
# (S)
# > Sina
...
# > 360doc
URL-REGEX,^https?+:\/\/mobi\.360doc\.com\/v\d{2}\/Ajax\/festival\.ashx\?op=getfestivaltheme,REJECT
# > 55海淘
URL-REGEX,^https?+:\/\/appv6\.55haitao\.com\/IflyAd\/getAd,REJECT
# > 58同城
URL-REGEX,^https?+:\/\/.+?\.58cdn\.com\.cn\/brandads\/,REJECT
URL-REGEX,^https?+:\/\/app\.58\.com\/api\/home\/a(?>dvertising|ppadv)\/,REJECT
URL-REGEX,^https?+:\/\/app\.58\.com\/api\/home\/invite\/popupAdv,REJECT
URL-REGEX,^https?+:\/\/app\.58\.com\/api\/log\/,REJECT

# A
# > 阿里
URL-REGEX,^https?+:\/\/amdc\.m\.taobao\.com\/amdc\/mobileDispatch,REJECT
...
# > AcFun
URL-REGEX,^https?+:\/\/aes\.acfun\.cn\/s\?adzones,REJECT
# > 爱回收
...
# > APICloud
URL-REGEX,^https?+:\/\/a\.apicloud\.com\/start_page\/,REJECT

# B
# > 百度
# >> 百度网盘
URL-REGEX,^https?+:\/\/pan\.baidu\.com\/rest\/2\.0\/pcs\/adx,REJECT
...
# >> 百度地图
URL-REGEX,^https?+:\/\/ss0\.bdstatic\.com/.+?_\d{3}_\d{4}\.jpg,REJECT
# >> 爱奇艺
URL-REGEX,^https?+:\/\/iface\.iqiyi\.com\/api\/getNewAdInfo,REJECT
URL-REGEX,^https?+:\/\/.+?\/(?>mixer|track2)\?,REJECT
URL-REGEX,^https?+:\/\/act\.vip\.iqiyi\.com\/interact\/api\/show\.do,REJECT
URL-REGEX,^https?+:\/\/act\.vip\.iqiyi\.com\/interact\/api\/v2\/show,REJECT
# > 哔哩哔哩
URL-REGEX,^https?+:\/\/app\.bilibili\.com\/x\/v\d\/splash\/,REJECT
URL-REGEX,^https?+:\/\/manga\.bilibili\.com\/twirp\/comic\.v\d\.Comic\/Flash,REJECT
# > 抱抱
URL-REGEX,^https?+:\/\/www\.myhug\.cn\/ad\/,REJECT
# > 百词斩
URL-REGEX,^https?+:\/\/7n\.bczcdn\.com\/launchad\/,REJECT
# > 贝太厨房
URL-REGEX,^https?+:\/\/channel\.beitaichufang\.com\/channel\/api\/v\d\/promote\/ios\/start\/page,REJECT
# > 币世界
URL-REGEX,^https?+:\/\/iapi\.bishijie\.com\/actopen\/advertising\/,REJECT
# > 贝壳找房
URL-REGEX,^https?+:\/\/app\.api\.ke\.com\/config\/config\/bootpage,REJECT
# > 薄荷
URL-REGEX,^https?+:\/\/status\.boohee\.com\/api\/v\d\/app_square\/start_up_with_ad,REJECT

# C
# > CNKI
# >> 手机知网
URL-REGEX,^https?+:\/\/xyz\.cnki\.net\/resourcev7\/api\/manualpush\/SlidsList$,REJECT
# > CNTV
URL-REGEX,^https?+:\/\/cntv\.hls\.cdn\.myqcloud\.com\/.+?\?maxbr=850,REJECT
URL-REGEX,^https?+:\/\/asp\.cntv\.myalicdn\.com\/.+?\?maxbr=850,REJECT
URL-REGEX,^https?+:\/\/www\.cntv\.cn\/nettv\/adp\/,REJECT
URL-REGEX,^https?+:\/\/v\.cctv\.com\/.+?850,REJECT
# > CSDN
URL-REGEX,^https?+:\/\/gw\.csdn\.net\/cms-app\/v2\/home_page\/open_advertisement,REJECT
# > 车来了
URL-REGEX,^https?+:\/\/api\.chelaile\.net\.cn\/adpub\/,REJECT
URL-REGEX,^https?+:\/\/api\.chelaile\.net\.cn\/goocity\/advert\/,REJECT
URL-REGEX,^https?+:\/\/pic\d\.chelaile\.net\.cn\/adv\/,REJECT
# > 曹操出行
URL-REGEX,^https?+:\/\/cap\.caocaokeji\.cn\/advert-bss\/,REJECT
# > 财经
URL-REGEX,^https?+:\/\/api\.caijingmobile\.com\/ad(?:vert)?+\/,REJECT
# > 超级课程表
URL-REGEX,^https?+:\/\/.+?\/V\d\/splash\/getSplashV\d\.action,REJECT
# > 超级星饭团
URL-REGEX,^https?+:\/\/g\.cdn\.pengpengla\.com\/starfantuan\/boot-screen-info\/,REJECT
# > 超星学习通
...
# > 蛋蛋赞
URL-REGEX,^https?+:\/\/www\.dandanzan\.com\/res\/gdsefse\.js,REJECT
# > 叨鱼
...
# > 毒
URL-REGEX,^https?+:\/\/app\.poizon\.com\/api\/v1\/app\/advertisement\/adv\/,REJECT

# E
# > 艺龙
IP-CIDR,119.18.193.135/32,REJECT,no-resolve
IP-CIDR,123.59.31.1/32,REJECT,no-resolve
URL-REGEX,^https?+:\/\/mobile-api2011\.elong\.com\/ad(?>v|gateway),REJECT
# > e代驾
...
# > 凤凰秀
URL-REGEX,^https?+:\/\/dsa-mfp\.fengshows\.cn\/mfp\/mfpMultipleDelivery\.do\?.+?adunitid,REJECT

# G
# > Google
# >> Youtube
URL-REGEX,^https?+:\/\/.+?\.googlevideo\.com\/.+?(?>&oad|ctier),REJECT
URL-REGEX,^https?+:\/\/\w+?\.youtube\.com\/api\/.+?ad,REJECT
URL-REGEX,^https?+:\/\/\w+?\.youtube\.com\/p(?>agead|tracking),REJECT
URL-REGEX,^https?+:\/\/youtubei\.googleapis\.com\/youtubei\/.+?(?>ad|log)_,REJECT
# > Gofun
URL-REGEX,^https?+:\/\/gateway\.shouqiev\.com\/fsda\/app\/bootImage\.json,REJECT
# > 国泰君安
URL-REGEX,^https?+:\/\/dl\.app\.gtja\.com\/dzswem\/kvController\/.+?\.jpg$,REJECT
...
# > 虎扑
URL-REGEX,^https?+:\/\/games\.mobileapi\.hupu\.com\/\d\/(?:\d\.){2}\d\/status\/init,REJECT
# > 虎牙
...
# > 韩剧社
URL-REGEX,^https?+:\/\/47\.97\.20\.12\/ad\/,REJECT
# > 火猫
URL-REGEX,^https?+:\/\/api\.huomao\.com\/channels\/loginAd,REJECT
# > HiveBox
URL-REGEX,^https?+:\/\/consumer\.fcbox\.com\/v\d\/ad\/,REJECT
# > 好好住
URL-REGEX,^https?+:\/\/api\.haohaozhu\.cn\/index\.php\/home\/AppInit\/getStartPhoto,REJECT
# > 花生地铁
...
URL-REGEX,^https?+:\/\/richmanapi\.jxedt\.com\/api\/ad\/,REJECT
# > 驾考宝典
URL-REGEX,^https?+:\/\/.+?\.kakamobi\.cn\/api\/open\/v\d\/advert-sdk\/,REJECT
# > 金山 WPS
...
# > 金山词霸
URL-REGEX,^https?+:\/\/dict-mobile\.iciba\.com\/interface\/index\.php\?.+?(?>c=ad|collectFeedsAdShowCount|KSFeedsAdCardViewController),REJECT
URL-REGEX,^https?+:\/\/service\.iciba\.com\/popo\/open\/screens\/v\d\?adjson,REJECT

# K
# > Keep
URL-REGEX,^https?+:\/\/api\.gotokeep\.com\/ads,REJECT
URL-REGEX,^https?+:\/\/static1\.keepcdn\.com\/.+?\d{3}x\d{4},REJECT
# > 快递100
URL-REGEX,^https?+:\/\/p\.kuaidi100\.com\/mobile\/mobileapi\.do,REJECT
# > 快看漫画
URL-REGEX,^https?+:\/\/api\.kkmh\.com\/.+?ad(?:vertisement)?+\/,REJECT
# > 酷我
...
# L
# > 乐视
URL-REGEX,^https?+:\/\/.+?\/letv-gug\/,REJECT
# > 来疯直播
URL-REGEX,^https?+:\/\/api\.laifeng\.com\/v\d\/start\/ads,REJECT
# > 懒投资
URL-REGEX,^https?+:\/\/ios\.lantouzi\.com\/api\/startpage,REJECT
# > 旅法师营地
URL-REGEX,^https?+:\/\/www\.iyingdi\.cn\/ad,REJECT
...
URL-REGEX,^https?+:\/\/api-mifit.+?\.huami\.com\/discovery\/mi\/discovery\/.+?_ad\?,REJECT
# > 蘑菇租房
URL-REGEX,^https?+:\/\/api\.mgzf\.com\/renter-operation\/home\/startHomePage,REJECT
# > 墨迹天气
URL-REGEX,^https?+:\/\/cdn\.moji\.com\/ad(?>oss|link)\/,REJECT
# > 埋堆堆
URL-REGEX,^https?+:\/\/mob\.mddcloud\.com\.cn\/api\/ad(?:vert)?+\/,REJECT
# > 漫画人
URL-REGEX,^https?+:\/\/mangaapi\.manhuaren\.com\/v\d\/public\/getStartPageAds,REJECT
# > 美团
URL-REGEX,^https?+:\/\/img\.meituan\.net\/(?>adunion|display|midas)\/.+?\.(gif|jpg|jpg\.webp)$,REJECT
URL-REGEX,^https?+:\/\/p\d\.meituan\.net\/wmbanner\/[A-Za-z0-9]+?\.jpg,REJECT
URL-REGEX,^https?+:\/\/p\d\.meituan\.net\/movie\/[A-Za-z0-9]+?\.jpg\?may_covertWebp,REJECT
URL-REGEX,^https?+:\/\/s3plus\.meituan\.net\/.+?\/linglong\/.+?\.(?>gif|jpg|mp4),REJECT
# > 美味不用等
URL-REGEX,^https?+:\/\/capi\.mwee\.cn\/app-api\/V\d{2}\/app\/(?:getstart)?+ad,REJECT
# > 秒拍
...
# > 美篇
URL-REGEX,^https?+:\/\/api\.meipian\.me.+?advert,REJECT

# N
# > 爱南宁
URL-REGEX,^https?+:\/\/nnapp\.cloudbae\.cn\/mc\/api\/advert,REJECT
# > NationalGeographic
...
# O
# > ofo
URL-REGEX,^https?+:\/\/supportda\.ofo\.com\/adaction\?,REJECT
URL-REGEX,^https?+:\/\/ma\.ofo\.com\/ads\/,REJECT
URL-REGEX,^https?+:\/\/activity2\.api\.ofo\.com\/ofo\/Api\/v2\/ads,REJECT
URL-REGEX,^https?+:\/\/ma\.ofo\.com\/adImage\/,REJECT
# > Oray
URL-REGEX,^https?+:\/\/slapi\.oray\.net\/client\/ad,REJECT

# P
# > PU口袋校园
URL-REGEX,^https?+:\/\/pocketuni\.net\/\?app=api&mod=Message&act=ad,REJECT
# > 票根
URL-REGEX,^https?+:\/\/pss\.txffp\.com\/piaogen\/images\/launchScreen,REJECT
# > 拼多多
URL-REGEX,^https?+:\/\/api\.yangkeduo\.com\/api\/cappuccino\/splash,REJECT

# Q
# > Qdaily
URL-REGEX,^https?+:\/\/app\d\.qdaily\.com\/app\d\/boot_advertisements\.json,REJECT
URL-REGEX,^https?+:\/\/notch\.qdaily\.com\/api\/v\d\/boot_ad,REJECT
# > 穷游
...
# > 日日煮
URL-REGEX,^https?+:\/\/api\.daydaycook\.com\.cn\/daydaycook\/server\/ad\/,REJECT
URL-REGEX,^https?+:\/\/cms\.daydaycook\.com\.cn\/api\/cms\/advertisement\/,REJECT
...
# > 神舟专车
URL-REGEX,^https?+:\/\/img01\.10101111cdn\.com\/adpos\/,REJECT
# > 省点
URL-REGEX,^https?+:\/\/api\.waitwaitpay\.com\/\/api\/splash,REJECT
# > 识货
URL-REGEX,^https?+:\/\/www\.shihuo\.cn\/app\d\/saveAppInfo,REJECT
# > 首汽约车
URL-REGEX,^https?+:\/\/gw-passenger\.01zhuanche\.com\/gw-passenger\/car-rest\/webservice\/passenger\/recommendADs,REJECT
URL-REGEX,^https?+:\/\/gw-passenger\.01zhuanche\.com\/gw-passenger\/zhuanche-passenger-token\/leachtoken\/webservice\/homepage\/queryADs,REJECT
# > 顺丰速运
...
# > 搜狗
URL-REGEX,^https?+:\/\/business-cdn\.shouji\.sogou\.com\/wapdl\/hole\/.+?\.jpg,REJECT
# > 搜狐
URL-REGEX,^https?+:\/\/api\.k\.sohu\.com\/api\/news\/adsense,REJECT
URL-REGEX,^https?+:\/\/pic\.k\.sohu\.com\/img8\/wb\/tj\/,REJECT
URL-REGEX,^https?+:\/\/s1\.api\.tv\.itc\.cn\/v4\/mobile\/control\/switch\.json,REJECT
URL-REGEX,^https?+:\/\/api\.tv\.sohu\.com\/agg\/api\/app\/config\/bootstrap,REJECT
# > 苏宁
...
# >> 全民K歌
URL-REGEX,^https?+:\/\/y\.gtimg\.cn\/music\/common\/\/upload\/kg_ad\/.+?\d{3,4}+x\d{4},REJECT
# >> 腾讯游戏
URL-REGEX,^https?+:\/\/ssl\.kohsocialapp\.qq\.com:10001\/game\/buttons,REJECT
URL-REGEX,^https?+:\/\/qt\.qq\.com\/lua\/mengyou\/get_splash_screen_info,REJECT
# >> 腾讯地图
URL-REGEX,^https?+:\/\/3gimg\.qq\.com\/tencentMapTouch\/app\/activity\/,REJECT
URL-REGEX,^https?+:\/\/3gimg\.qq\.com\/tencentMapTouch\/splash\/,REJECT
URL-REGEX,^https?+:\/\/4gimg\.map\.qq\.com\/mwaSplash\/,REJECT
# >> 腾讯视频
IP-CIDR,111.30.159.168/32,REJECT,no-resolve
IP-CIDR,111.30.176.111/32,REJECT,no-resolve
URL-REGEX,^https?+:\/\/vv\.video\.qq\.com\/getvmind\?,REJECT
URL-REGEX,^https?+:\/\/(?:(?:25[0-5]|2[0-4]\d|1\d{2}|[1-9]?\d)\.){3}(?:25[0-5]|2[0-4]\d|1\d{2}|[1-9]?\d)\/.+?\.tc\.qq\.com\/.+?p201\.1\.mp4\?,REJECT
# >> 腾讯新闻
...
# >> JOOX
URL-REGEX,^https?+:\/\/hk\.app\.joox\.com\/retrieval\/getAd,REJECT
URL-REGEX,^https?+:\/\/hk\.app\.joox\.com\/billsrv\/clientBatchAdReport,REJECT
IP-CIDR,203.205.239.44/32,REJECT,no-resolve
IP-CIDR,203.205.255.16/32,REJECT,no-resolve
URL-REGEX,^https?+:\/\/smusic\.app\.wechat\.com\/commonCgi\/advertisement\/get_orint_egg$,REJECT
URL-REGEX,^https?+:\/\/smusic\.app\.wechat\.com\/fcgi-bin\/get_(?>a|i),REJECT
URL-REGEX,^https?+:\/\/tiasdk\.app\.wechat\.com\/retrieval\/getAdInfo$,REJECT
URL-REGEX,^https?+:\/\/mm\.app\.joox\.com\/retrieval\/getAd,REJECT
URL-REGEX,^https?+:\/\/mm\.app\.joox\.com\/billsrv\/clientBatchAdReport$,REJECT
# >> 微信
...
# V
# > VUE
URL-REGEX,^https?+:\/\/static\.vuevideo\.net\/styleAssets\/.+?\/splash_ad,REJECT
URL-REGEX,^https?+:\/\/static\.vuevideo\.net\/styleAssets\/advertisement\/,REJECT
...
# >> 网易考拉
URL-REGEX,^https?+:\/\/kaola-haitao\.oss\.kaolacdn.com\/.+?_\d{3,4}+_\d{4}\.jpg\?x-oss-process=image\/resize,m_mfit,w_\d{3,4}+,h_\d{4}\/format,webp\/quality,Q_85,REJECT
# >> 网易严选
URL-REGEX,^https?+:\/\/support\.you\.163\.com\/xhr\/boot\/getBootMedia\.json,REJECT
# >> 网易蜗牛读书
URL-REGEX,^https?+:\/\/easyreadfs\.nosdn\.127\.net\/ad-material\/,REJECT
URL-REGEX,^https?+:\/\/p\.du\.163\.com\/ad\/,REJECT
# >> 有道词典
URL-REGEX,^https?+:\/\/oimage[a-z][0-9]\.ydstatic\.com\/.+?adpublish,REJECT
URL-REGEX,^https?+:\/\/dsp-impr2\.youdao\.com\/adload,REJECT
# > 微医
...
# > WiFi共享大师
URL-REGEX,^https?+:\/\/nochange\.ggsafe\.com\/ad\/,REJECT
# > 微店
URL-REGEX,^https?+:\/\/thor\.weidian\.com\/ares\/home\.splash\/,REJECT
# > 华尔街见闻
URL-REGEX,^https?+:\/\/api\.wallstreetcn\.com\/apiv\d\/advertising\/,REJECT

# X
# > 新浪
URL-REGEX,^https?+:\/\/edit\.sinaapp\.com\/ua\?t=adv,REJECT
# >> 新浪微博
...
# >> 新浪天气通
URL-REGEX,^https?+:\/\/tqt\.weibo\.cn\/overall\/redirect\.php\?r=tqt,REJECT
URL-REGEX,^https?+:\/\/tqt\.weibo\.cn\/.+?advert\.index,REJECT
...
# > 小猿搜题
URL-REGEX,^https?+:\/\/xyst\.yuanfudao\.com\/iphone\/splashesV\d,REJECT
# > 新片场
URL-REGEX,^https?+:\/\/app\.xinpianchang\.com\/open_screen\?,REJECT
# > 雪球
...
# > 喜马拉雅
URL-REGEX,^https?+:\/\/\w+?\.ximalaya\.com\/api\/v\d\/adRealTime,REJECT
URL-REGEX,^https?+:\/\/(?:(?:25[0-5]|2[0-4]\d|1\d{2}|[1-9]?\d)\.){3}(?:25[0-5]|2[0-4]\d|1\d{2}|[1-9]?\d)\/ting\/preload\/,REJECT
# > 小站
URL-REGEX,^https?+:\/\/tiku\.zhan\.com\/Common\/newAd\/,REJECT

# Y
# > Yahoo!
URL-REGEX,^https?+:\/\/m\.yap\.yahoo\.com\/v\d{2}\/getAds\.do,REJECT
# > Youtube++
URL-REGEX,^https?+:\/\/api\.catch\.gift\/api\/v\d\/pagead\/,REJECT
# > 萤石云视频
URL-REGEX,^https?+:\/\/i\.ys7\.com\/api\/ads,REJECT
# > 阅达教育
URL-REGEX,^https?+:\/\/www\.hxeduonline\.com\/mobileapi2\/index\.php\?act=index&op=interdict,REJECT
# > 运动世界
URL-REGEX,^https?+:\/\/.+?\.iydsj\.com\/api\/.+?\/ad,REJECT
# > 一点万象
...
# > 迅雷
URL-REGEX,^https?+:\/\/images\.client\.vip\.xunlei\.com\/.+?\/advert\/,REJECT
# > 讯飞
URL-REGEX,^https?+:\/\/imeclient\.openspeech\.cn\/adservice\/,REJECT

# Z
# > 转转
URL-REGEX,^https?+:\/\/app\.zhuanzhuan\.com\/zzx\/transfer\/getConfigInfo$
# > 直播吧
URL-REGEX,^https?+:\/\/a\.qiumibao\.com\/activities\/config\.php,REJECT
URL-REGEX,^https?+:\/\/.+?\/allOne\.php\?ad_name,REJECT
# > 知乎
URL-REGEX,^https?+:\/\/api\.zhihu\.com\/(?>launch|real_time),REJECT
URL-REGEX,^https?+:\/\/api\.zhihu\.com\/commercial_api\/(?>launch|real_time),REJECT
URL-REGEX,^https?+:\/\/api\.zhihu\.com\/fringe\/ad,REJECT
URL-REGEX,^https?+:\/\/api\.zhihu\.com\/(?>ab|adx|xen|drama|zst|ad-style-service|market\/popover|search\/(?>top|tab|preset)|.*?(?>guide|recommendations|extended|featured-comment-ad)),REJECT
URL-REGEX,^https?+:\/\/www\.zhihu\.com\/api\/v4\/community-ad,REJECT
# > 追书神器
...
# > 字节跳动
URL-REGEX,^https?+:\/\/.+?\.pstatp\.com\/img\/ad,REJECT
URL-REGEX,^https?+:\/\/.+?\.(?>amemv|musical|snssdk|tiktokv)\.(?>com|ly)\/(?>api|motor)\/ad\/,REJECT
...
URL-REGEX,^https?+:\/\/.+?\/img\/ad\.union\.api\/,REJECT
# > 涨乐财富通
URL-REGEX,^https?+:\/\/d\.zhangle\.com\/pic\/cft\/interaction\/\d{13}-1242-2248\.jpg,REJECT
# > 中国大学慕课
URL-REGEX,^https?+:\/\/www\.icourse163\.org\/mob\/j\/v1\/mobRecommendRPCBean\.getMaxWeightAdvertisement\.rpc,REJECT
# > 中国银行
URL-REGEX,^https?+:\/\/mlife\.jf365\.boc\.cn\/AppPrj\/FirstPic\.do\?,REJECT
# > 中国工商银行
URL-REGEX,^https?+:\/\/v\.icbc\.com\.cn\/userfiles\/Resources\/WAP\/advertisement\/,REJECT
# > 中国招商银行
URL-REGEX,^https?+:\/\/pic1cdn\.cmbchina\.com\/appinitads\/,REJECT
# > 中国民生银行
URL-REGEX,^https?+:\/\/www\.cmbc\.com\.cn\/m\/image\/loadingpage\/,REJECT
# > 中国广发银行
URL-REGEX,^https?+:\/\/mps\.95508\.com\/mps\/club\/cardPortals\/adv\/.{25}\.jpg,REJECT
# > 中国移动
# >> 手机营业厅
...
# >> 咪咕
URL-REGEX,^https?+:\/\/gg\w+?\.cmvideo\.cn\/v\d\/iflyad\/,REJECT
URL-REGEX,^https?+:\/\/ggic\d?\.cmvideo\.cn\/ad\/,REJECT
URL-REGEX,^https?+:\/\/ggx\.cmvideo\.cn\/request\/,REJECT
URL-REGEX,^https?+:\/\/.+?\/cdn-adn\/,REJECT
# > 中国联通
...
# > Apple Non-China CDN
DOMAIN-SUFFIX,hls.itunes.apple.com,PROXY
# >> Apple URL Shortener
DOMAIN-SUFFIX,appsto.re,PROXY
# >> Developer
DOMAIN,devimages-cdn.apple.com,PROXY
DOMAIN,devstreaming-cdn.apple.com,PROXY
DOMAIN,js-cdn.music.apple.com,PROXY
...
DOMAIN,cdn.apple-cloudkit.com,PROXY
# >> Movie Stream
...
# > HBO GO HKG
USER-AGENT,HBO%20GO%20PROD%20HKG*,PROXY
